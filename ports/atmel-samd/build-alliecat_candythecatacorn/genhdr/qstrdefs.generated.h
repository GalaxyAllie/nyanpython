...
// 37 % 72 11101010 234
// 46 . 63 11101011 235
// 65 A 51 11101100 236
// 69 E 59 11101101 237
// 73 I 46 11101110 238
// 80 P 53 11101111 239
...
// 67 C 36 111101101 493
// 68 D 25 111101110 494
// 78 N 37 111101111 495
// 79 O 32 111110000 496
// 82 R 28 111110001 497
// 83 S 36 111110010 498
// 84 T 29 111110011 499
// 85 U 22 111110100 500
// 106 j 38 111110101 501
// 44 , 13 1111101100 1004
// 49 1 18 1111101101 1005
// 50 2 17 1111101110 1006
// 51 3 11 1111101111 1007
// 53 5 16 1111110000 1008
// 54 6 10 1111110001 1009
// 58 : 13 1111110010 1010
// 66 B 14 1111110011 1011
// 70 F 11 1111110100 1012
// 76 L 17 1111110101 1013
// 77 M 20 1111110110 1014
// 122 z 15 1111110111 1015
// 42 * 9 11111110000 2032
// 52 4 5 11111110001 2033
...
// 87 W 10 11111111001 2041
// 88 X 8 11111111010 2042
// 33 ! 4 111111110110 4086
// 34 \" 4 111111110111 4087
// 35 # 4 111111111000 4088
// 55 7 3 111111111001 4089
// 57 9 4 111111111010 4090
// 61 = 4 111111111011 4091
// 89 Y 4 111111111100 4092
// 96 ` 4 111111111101 4093
// 59 ; 1 1111111111100 8188
// 123 { 2 1111111111101 8189
// 125 } 2 1111111111110 8190
// 43 + 1 11111111111110 16382
// 90 Z 1 11111111111111 16383
// length count {3: 1, 4: 8, 5: 5, 6: 7, 7: 3, 8: 9, 9: 16, 10: 12, 11: 11, 12: 8, 13: 3, 14: 2}
// values ['e', ' ', 'a', 'i', 'n', 'o', 'r', 's', 't', 'c', 'd', 'l', 'p', 'u', '_', 'b', 'f', 'g', 'h', 'm', 'y', "'", 'v', 'w', '%', '.', 'A', 'E', 'I', 'P', 'k', 'q', 'x', '\n', '\r', '(', ')', '-', '/', '0', 'C', 'D', 'N', 'O', 'R', 'S', 'T', 'U', 'j', ',', '1', '2', '3', '5', '6', ':', 'B', 'F', 'L', 'M', 'z', '*', '4', '8', '<', '>', 'G', 'H', 'K', 'V', 'W', 'X', '!', '"', '#', '7', '9', '=', 'Y', '`', ';', '{', '}', '+', 'Z'] lengths 15 bytearray(b'\x00\x00\x01\x08\x05\x07\x03\t\x10\x0c\x0b\x08\x03\x02\x00')
// estimated total memory size 67826
// ['e', ' ', 'a', 'i', 'n', 'o', 'r', 's', 't', 'c', 'd', 'l', 'p', 'u', '_', 'b', 'f', 'g', 'h', 'm', 'y', "'", 'v', 'w', '%', '.', 'A', 'E', 'I', 'P', 'k', 'q', 'x', '\n', '\r', '(', ')', '-', '/', '0', 'C', 'D', 'N', 'O', 'R', 'S', 'T', 'U', 'j', ',', '1', '2', '3', '5', '6', ':', 'B', 'F', 'L', 'M', 'z', '*', '4', '8', '<', '>', 'G', 'H', 'K', 'V', 'W', 'X', '!', '"', '#', '7', '9', '=', 'Y', '`', ';', '{', '}', '+', 'Z'] bytearray(b'\x00\x00\x01\x08\x05\x07\x03\t\x10\x0c\x0b\x08\x03\x02\x00')
...
TRANSLATION("expecting key:value for dict", 29, { 0x1e, 0x57, 0x14, 0x94, 0x5d, 0x4b, 0xc0, 0x71, 0xf9, 0x73, 0x3b, 0x60, 0x16, 0x8c, 0xe5, 0x54, 0xa4, 0x80 }) // expecting key:value for dict
...
TRANSLATION("\nPlease file an issue with the contents of your CIRCUITPY drive at \nhttps://github.com/adafruit/circuitpython/issues\n", 121, { 0xf3, 0xf9, 0xbb, 0xec, 0x0e, 0x01, 0x68, 0x96, 0x04, 0x6a, 0x49, 0x11, 0x80, 0x5d, 0x12, 0x76, 0x29, 0xd8, 0x15, 0x19, 0x64, 0x2c, 0xc1, 0x36, 0x85, 0xc3, 0x61, 0xcb, 0xdb, 0xdd, 0xf1, 0xf6, 0xfd, 0x3b, 0xbe, 0x7d, 0xff, 0xf8, 0x55, 0x74, 0xe6, 0x08, 0xe4, 0xbc, 0xfe, 0x6d, 0xa6, 0x6f, 0x1f, 0x97, 0xaf, 0xd7, 0xaa, 0x4e, 0xd8, 0xcf, 0xae, 0x8d, 0xbf, 0xac, 0xea, 0x7a, 0x3e, 0x12, 0x7d, 0x74, 0x47, 0xa6, 0x12, 0x6f, 0xc4, 0xec, 0xcb, 0xeb, 0x48, 0x8c, 0x08, 0xf3, 0xf9, 0x80 }) // \r\nPlease file an issue with the contents of your CIRCUITPY drive at \r\nhttps://github.com/adafruit/circuitpython/issues\r\n
...
TRANSLATION("Length must be an int", 22, { 0xfd, 0x42, 0xeb, 0x3b, 0x16, 0xf8, 0x89, 0x2c, 0xc1, 0x1a, 0x92, 0x2c, 0x80 }) // Length must be an int
...
TRANSLATION("expected ':' after format specifier", 36, { 0x1e, 0x57, 0x14, 0x91, 0x52, 0xe5, 0xf9, 0x72, 0x23, 0xd2, 0x43, 0x96, 0x8c, 0xfb, 0x9c, 0x94, 0x5c, 0x51, 0x34, 0x40, 0xe0 }) // expected \':\' after format specifier
...
TRANSLATION("\nCode done running. Waiting for reload.\n", 43, { 0xf3, 0xf9, 0xbd, 0xad, 0x50, 0x55, 0x65, 0x04, 0xf8, 0x55, 0x45, 0xd7, 0xac, 0xbf, 0xc9, 0xa4, 0xa2, 0xea, 0x5a, 0x33, 0x93, 0x8b, 0x31, 0xd7, 0xaf, 0xcf, 0xe6 }) // \r\nCode done running. Waiting for reload.\r\n
...
TRANSLATION("Function requires lock", 23, { 0xfd, 0x30, 0xb4, 0x94, 0x65, 0x27, 0x1e, 0x38, 0x47, 0x10, 0x56, 0x6a, 0x78, 0x00 }) // Function requires lock
...
TRANSLATION("You are in safe mode: something unanticipated happened.\n", 58, { 0xff, 0xc6, 0xc1, 0x1b, 0x82, 0x45, 0x28, 0x3d, 0x01, 0x6e, 0xd5, 0x1f, 0x91, 0x43, 0x6e, 0x27, 0x64, 0x5d, 0x4b, 0x0a, 0x6b, 0x29, 0x44, 0xb9, 0xc8, 0xa9, 0x6c, 0x77, 0xb8, 0x51, 0x5e, 0xbf, 0x3f, 0x98 }) // You are in safe mode: something unanticipated happened.\r\n
...
TRANSLATION("Brightness must be between 0 and 255", 37, { 0xfc, 0xdd, 0x35, 0xda, 0x54, 0x44, 0x16, 0xf8, 0x89, 0x2c, 0xc1, 0x66, 0x27, 0xa0, 0x0a, 0x5e, 0xc2, 0x35, 0xa9, 0x7d, 0xdf, 0x87, 0xe0 }) // Brightness must be between 0 and 255
...
TRANSLATION("threshold must be in the range 0-65536", 39, { 0x9d, 0x9c, 0x46, 0xcd, 0x6a, 0x96, 0xf8, 0x89, 0x2c, 0xc1, 0x22, 0x94, 0xec, 0x09, 0xcd, 0x75, 0x05, 0xec, 0xf5, 0x7e, 0x3f, 0x87, 0xe1, 0xf7, 0xfe, 0x20 }) // threshold must be in the range 0-65536
...
TRANSLATION("Buffer must be at least length 1", 33, { 0xfc, 0xf1, 0xa6, 0x81, 0xcb, 0x7c, 0x44, 0x96, 0x60, 0x8e, 0x4a, 0xc0, 0xe2, 0x4a, 0xc1, 0x75, 0x9d, 0x8b, 0xed }) // Buffer must be at least length 1
...
TRANSLATION("Failed to write internal flash.", 32, { 0xfd, 0x0d, 0x2c, 0x2a, 0x52, 0xc5, 0xd1, 0xd2, 0x41, 0x22, 0xc8, 0x75, 0x3b, 0x16, 0x96, 0x38, 0xdb, 0xac }) // Failed to write internal flash.
TRANSLATION("No TX pin", 10, { 0xf7, 0xb1, 0x7c, 0xff, 0xd1, 0x5d, 0x14 }) // No TX pin
TRANSLATION("Unable to init parser", 22, { 0xfa, 0x29, 0xe7, 0x60, 0x52, 0xc4, 0x8a, 0x92, 0x57, 0x37, 0x80, 0xe0 }) // Unable to init parser
TRANSLATION("Length must be non-negative", 28, { 0xfd, 0x42, 0xeb, 0x3b, 0x16, 0xf8, 0x89, 0x2c, 0xc1, 0x2b, 0x2f, 0xa9, 0x46, 0xa7, 0x29, 0xcc, 0x00 }) // Length must be non-negative
...
TRANSLATION("Stack size must be at least 256", 32, { 0xf9, 0x49, 0xd3, 0xc0, 0xa1, 0x3f, 0x70, 0x5b, 0xe2, 0x24, 0xb3, 0x04, 0x72, 0x56, 0x07, 0x12, 0x5f, 0x77, 0xe1, 0xf8, 0x80 }) // Stack size must be at least 256
...
TRANSLATION("bits must be 7, 8 or 9", 23, { 0xcd, 0x26, 0x0b, 0x7c, 0x44, 0x96, 0x60, 0xbf, 0xe7, 0xec, 0x2f, 0xe4, 0x4c, 0xe5, 0xff, 0x40 }) // bits must be 7, 8 or 9
TRANSLATION("string not supported; use bytes or bytearray", 45, { 0x89, 0x74, 0x5d, 0x49, 0x5a, 0x4a, 0x31, 0x7b, 0xb3, 0xc8, 0xaf, 0xff, 0x0b, 0x10, 0x0b, 0x3e, 0x24, 0x41, 0x33, 0x96, 0x7c, 0x48, 0x37, 0x73, 0xe0 }) // string not supported; use bytes or bytearray
TRANSLATION("No RX pin", 10, { 0xf7, 0xb1, 0x7c, 0x7f, 0xd1, 0x5d, 0x14 }) // No RX pin
...
TRANSLATION("File exists", 12, { 0xfd, 0x12, 0xc0, 0x87, 0x92, 0x44, 0xc0 }) // File exists
...
TRANSLATION("Incompatible .mpy file. Please update all .mpy files. See http://adafru.it/mpy-update for more info.", 101, { 0xee, 0x5a, 0x36, 0xf7, 0x39, 0x4c, 0xec, 0x0b, 0xaf, 0x7b, 0xf0, 0x5a, 0x25, 0x87, 0x59, 0x77, 0xd8, 0x1c, 0x02, 0xc5, 0xea, 0x72, 0x08, 0xed, 0x62, 0xeb, 0xde, 0xfc, 0x16, 0x89, 0x61, 0x1d, 0x65, 0xf2, 0x00, 0xb6, 0x99, 0xbf, 0xe5, 0xeb, 0xf5, 0x9d, 0x4f, 0x47, 0xc7, 0x5a, 0x4f, 0xaf, 0x7b, 0xf1, 0xea, 0xc5, 0xea, 0x72, 0x0b, 0x46, 0x72, 0xdd, 0x9c, 0x12, 0x2e, 0x8d, 0xd6 }) // Incompatible .mpy file. Please update all .mpy files. See http://adafru.it/mpy-update for more info.
...
TRANSLATION(" output:\n", 11, { 0x26, 0xc4, 0xdf, 0x13, 0xf9, 0x79, 0xfc, 0xc0 }) //  output:\r\n
...
TRANSLATION("SDA or SCL needs a pull up", 27, { 0xf9, 0x7b, 0xbb, 0x09, 0x9c, 0xbe, 0x5e, 0xdf, 0xd4, 0x94, 0x0a, 0xc1, 0x19, 0x5f, 0x16, 0xb1, 0x62, 0xe0 }) // SDA or SCL needs a pull up
...
TRANSLATION("EXTINT channel already in use", 30, { 0xed, 0xff, 0x5f, 0x3e, 0xef, 0x7f, 0xcc, 0xa9, 0xb1, 0xaa, 0x8b, 0x11, 0xd9, 0xc1, 0xd7, 0x82, 0x45, 0x2c, 0x40 }) // EXTINT channel already in use
...
TRANSLATION("'=' alignment not allowed in string format specifier", 53, { 0xe5, 0xff, 0x7c, 0x88, 0xec, 0x9a, 0xae, 0xe1, 0x64, 0x95, 0xa4, 0x8e, 0xd6, 0x6e, 0x82, 0xa4, 0x8a, 0x51, 0x2e, 0x8b, 0xa9, 0x68, 0xcf, 0xb9, 0xc9, 0x45, 0xc5, 0x13, 0x44, 0x0e }) // \'=\' alignment not allowed in string format specifier
...
TRANSLATION("Both pins must support hardware interrupts", 43, { 0xfc, 0xda, 0x76, 0x2b, 0xa2, 0xc1, 0x6f, 0x88, 0x92, 0x8c, 0x5e, 0xec, 0xf2, 0x5b, 0x1b, 0xd7, 0xa1, 0xb8, 0x24, 0x59, 0x0e, 0xf8, 0xbc, 0xc0 }) // Both pins must support hardware interrupts
TRANSLATION("exceptions must derive from BaseException", 42, { 0x1e, 0x54, 0x17, 0x94, 0x65, 0x82, 0xdf, 0x11, 0x25, 0x50, 0xe9, 0xcc, 0x16, 0x8e, 0xdb, 0x97, 0xe6, 0x70, 0x3b, 0x7c, 0xa8, 0x2f, 0x28, 0xca }) // exceptions must derive from BaseException
TRANSLATION("Welcome to Adafruit CircuitPython %s!\n\nPlease visit learn.adafruit.com/category/circuitpython for project guides.\n\nTo list built-in modules please do `help(\"modules\")`.\n", 175, { 0xff, 0x22, 0xd4, 0x6d, 0xc1, 0x4b, 0x17, 0x65, 0x4f, 0x47, 0xc2, 0x49, 0x7b, 0x51, 0xe9, 0x84, 0x9e, 0xfe, 0x27, 0x66, 0x52, 0xea, 0x8f, 0xf6, 0xf3, 0xf9, 0xbc, 0xfe, 0x6e, 0xfb, 0x03, 0x80, 0x5c, 0xd2, 0x12, 0x4a, 0xc0, 0xdd, 0x7a, 0xce, 0xa7, 0xa3, 0xe1, 0x27, 0xae, 0x8d, 0xbf, 0xae, 0x87, 0x23, 0x56, 0x7e, 0x3d, 0x74, 0x47, 0xa6, 0x12, 0x6f, 0xc4, 0xec, 0xca, 0x5a, 0x33, 0x95, 0xdd, 0xbe, 0xa2, 0x92, 0x5a, 0xe1, 0x2a, 0x23, 0xaf, 0xcf, 0xe6, 0xf3, 0xf9, 0xbe, 0x6c, 0x56, 0x48, 0x92, 0xcf, 0x09, 0x69, 0xf5, 0x22, 0x96, 0xed, 0x5c, 0x58, 0x41, 0x5e, 0xc0, 0xe0, 0x15, 0x58, 0xbf, 0xf7, 0x61, 0x6b, 0xfa, 0x3f, 0xdf, 0x76, 0xae, 0x2c, 0x23, 0xfd, 0xfd, 0x3f, 0xfb, 0xd7, 0xe7, 0xf3, 0x00 }) // Welcome to Adafruit CircuitPython %s!\r\n\r\nPlease visit learn.adafruit.com/category/circuitpython for project guides.\r\n\r\nTo list built-in modules please do `help(\"modules\")`.\r\n
...
TRANSLATION("time.struct_time() takes a 9-sequence", 38, { 0x94, 0xdc, 0x75, 0xc4, 0xbe, 0x29, 0x39, 0x4a, 0x6e, 0x3d, 0x1e, 0x92, 0x93, 0xf0, 0x10, 0x46, 0x5f, 0xf5, 0xea, 0x81, 0xe3, 0x80, 0xb4, 0x00 }) // time.struct_time() takes a 9-sequence
...
TRANSLATION("unsupported type for %q: '%s'", 30, { 0xc2, 0xc6, 0x2f, 0x76, 0x79, 0x15, 0x29, 0xe2, 0xe0, 0xb4, 0x67, 0x2e, 0xaf, 0x1f, 0xc8, 0xb9, 0x75, 0x47, 0x20 }) // unsupported type for %q: \'%s\'
...
TRANSLATION("MicroPython fatal error.", 25, { 0xfd, 0x92, 0x8e, 0xdd, 0xfc, 0x4e, 0xcc, 0xa5, 0xa1, 0xc9, 0xd8, 0x83, 0xbb, 0x3f, 0x58 }) // MicroPython fatal error.
...
TRANSLATION("Traceback (most recent call last):\n", 37, { 0xf9, 0xb9, 0xd0, 0x66, 0x74, 0xf0, 0x2f, 0x46, 0xed, 0x12, 0x4e, 0x28, 0x16, 0x4a, 0x87, 0x6b, 0x15, 0x8e, 0x27, 0xd3, 0xf9, 0x79, 0xfc, 0xc0 }) // Traceback (most recent call last):\r\n
...
TRANSLATION("WARNING: Your code filename has two extensions\n", 49, { 0xff, 0x3d, 0x9f, 0x1f, 0x7f, 0x77, 0xbf, 0xfa, 0xfe, 0x45, 0xff, 0x8d, 0x87, 0x2a, 0x35, 0x41, 0x68, 0x96, 0x0a, 0x7b, 0x82, 0xd8, 0xe0, 0xa7, 0xa3, 0x10, 0xf2, 0x90, 0xb0, 0x8c, 0xb1, 0xe7, 0xf3, 0x00 }) // WARNING: Your code filename has two extensions\r\n
TRANSLATION("Auto-reload is on. Simply save files over USB to run them or enter REPL to disable.\n", 86, { 0xec, 0xc4, 0xb7, 0xa9, 0xc5, 0x98, 0xea, 0x49, 0x04, 0xcb, 0xd6, 0x5f, 0x24, 0xde, 0xf6, 0xe0, 0xa0, 0xf9, 0x82, 0xd1, 0x2c, 0x20, 0x9b, 0x98, 0x72, 0xfa, 0x7c, 0xbf, 0x32, 0x96, 0x27, 0xc2, 0x94, 0xec, 0x37, 0x26, 0x72, 0x0b, 0x21, 0xcb, 0xe3, 0xdb, 0xdf, 0xfa, 0x94, 0xb1, 0x55, 0x20, 0xf3, 0xb0, 0xeb, 0xf3, 0xf9, 0x80 }) // Auto-reload is on. Simply save files over USB to run them or enter REPL to disable.\r\n
...
TRANSLATION("calibration value out of range +/-127", 38, { 0xa1, 0xd9, 0x33, 0x73, 0x94, 0x65, 0x2e, 0x67, 0x6c, 0x02, 0x6c, 0x49, 0x36, 0x84, 0xe6, 0xba, 0x82, 0xff, 0xfb, 0xd7, 0xea, 0xfb, 0x7e, 0xef, 0xf9 }) // calibration value out of range +/-127
...
TRANSLATION("int() arg 2 must be >= 2 and <= 36", 35, { 0x45, 0x9f, 0x47, 0xa4, 0x8d, 0xf5, 0x2f, 0xb8, 0xb7, 0xc4, 0x49, 0x66, 0x0b, 0xfa, 0x7f, 0xd9, 0x7d, 0xc4, 0x6b, 0x52, 0xfe, 0x7f, 0xf6, 0x5f, 0x7f, 0xe2 }) // int() arg 2 must be >= 2 and <= 36
...
TRANSLATION("unsupported types for %q: '%s', '%s'", 37, { 0xc2, 0xc6, 0x2f, 0x76, 0x79, 0x15, 0x29, 0xe2, 0xe2, 0x0b, 0x46, 0x72, 0xea, 0xf1, 0xfc, 0x8b, 0x97, 0x54, 0x72, 0xfb, 0x0b, 0x97, 0x54, 0x72 }) // unsupported types for %q: \'%s\', \'%s\'
...
TRANSLATION("MicroPython NLR jump failed. Likely memory corruption.", 55, { 0xfd, 0x92, 0x8e, 0xdd, 0xfc, 0x4e, 0xcc, 0xa5, 0xef, 0xfd, 0x7e, 0x25, 0xf5, 0xc6, 0xf7, 0x2d, 0x0d, 0x2c, 0x2b, 0xd6, 0x5f, 0xaa, 0x78, 0x0b, 0x70, 0x5b, 0x8d, 0xd9, 0xf8, 0x2a, 0x33, 0xbe, 0x2f, 0x28, 0xcb, 0xd6 }) // MicroPython NLR jump failed. Likely memory corruption.
...
TRANSLATION("PWM duty_cycle must be between 0 and 65535 inclusive (16 bit resolution)", 73, { 0xef, 0xff, 0x3f, 0xb1, 0x57, 0x13, 0xc6, 0x54, 0xe2, 0x96, 0x05, 0xbe, 0x22, 0x4b, 0x30, 0x59, 0x89, 0xe8, 0x02, 0x97, 0xb0, 0x8d, 0x6a, 0x5f, 0x8f, 0xe1, 0xf8, 0x7d, 0xff, 0x81, 0x22, 0xd2, 0xd8, 0x84, 0xe6, 0x0b, 0xd1, 0xf6, 0xfe, 0x25, 0x9a, 0x49, 0x38, 0x86, 0xb6, 0x25, 0x19, 0x7d, 0x20 }) // PWM duty_cycle must be between 0 and 65535 inclusive (16 bit resolution)
...
TRANSLATION("  File \"%q\", line %d", 21, { 0x22, 0xfd, 0x12, 0xc0, 0xbf, 0xdf, 0xab, 0xc7, 0xfd, 0xfe, 0xc2, 0xb2, 0x28, 0x2e, 0xaa, 0x80 }) //   File \"%q\", line %d
...
TRANSLATION("No free GCLKs", 14, { 0xf7, 0xb1, 0x68, 0xe0, 0x17, 0xf5, 0xf6, 0xfe, 0xbf, 0xde, 0x00 }) // No free GCLKs
...
TRANSLATION("Failed to allocate RX buffer of %d bytes", 41, { 0xfd, 0x0d, 0x2c, 0x2a, 0x52, 0xc4, 0x76, 0xb3, 0x50, 0xe4, 0x17, 0xc7, 0xfd, 0x16, 0x78, 0xd3, 0x40, 0xe4, 0xda, 0x17, 0x55, 0x4b, 0x3e, 0x24, 0x40 }) // Failed to allocate RX buffer of %d bytes
TRANSLATION("Invalid pins", 13, { 0xee, 0x5e, 0x67, 0x64, 0xa9, 0x5d, 0x16, 0x00 }) // Invalid pins
TRANSLATION("RTS/CTS/RS485 Not yet supported on this device", 47, { 0xf8, 0xfc, 0xfe, 0x5e, 0xbf, 0x6f, 0xcf, 0xe5, 0xeb, 0xf8, 0xfc, 0xbf, 0x8f, 0xf2, 0xfc, 0x0b, 0xde, 0xd2, 0x5c, 0x09, 0x28, 0xc5, 0xee, 0xcf, 0x22, 0xa4, 0xca, 0x53, 0xb2, 0x41, 0x54, 0x73, 0x4a, 0x00 }) // RTS/CTS/RS485 Not yet supported on this device
...
TRANSLATION("only slices with step=1 (aka None) are supported", 49, { 0x65, 0xb7, 0x05, 0x16, 0x4a, 0x08, 0x2e, 0x89, 0x3b, 0x14, 0x48, 0xbf, 0xfd, 0xfd, 0xa5, 0xe8, 0x3f, 0x03, 0x2f, 0x7b, 0x28, 0xf4, 0x91, 0xb8, 0x28, 0xc5, 0xee, 0xcf, 0x22, 0xa0 }) // only slices with step=1 (aka None) are supported
...
TRANSLATION("USB Error", 10, { 0xfa, 0x7c, 0xbf, 0x32, 0xed, 0x77, 0x67 }) // USB Error
TRANSLATION("AnalogOut is only 16 bits. Value must be less than 65536.", 58, { 0xec, 0x53, 0xb3, 0x6b, 0xf0, 0xc4, 0x92, 0x41, 0x32, 0xdb, 0x82, 0xfb, 0x7f, 0x12, 0xcd, 0x26, 0x3a, 0xcb, 0xfc, 0x1d, 0xb0, 0x0b, 0x7c, 0x44, 0x96, 0x60, 0xac, 0x22, 0x0a, 0x76, 0x35, 0x2f, 0xc7, 0xf0, 0xfc, 0x3e, 0xff, 0xc7, 0xac }) // AnalogOut is only 16 bits. Value must be less than 65536.
TRANSLATION("popitem(): dictionary is empty", 31, { 0xbb, 0x5d, 0x24, 0x6f, 0xe8, 0xf4, 0xfe, 0x45, 0x54, 0xa4, 0xa3, 0x29, 0xbf, 0x04, 0x90, 0x43, 0x7b, 0xcf, 0x00 }) // popitem(): dictionary is empty
TRANSLATION("The CircuitPython heap was corrupted because the stack was too small.\nPlease increase the stack size if you know how, or if not:", 130, { 0xf9, 0xec, 0x0b, 0xda, 0x8f, 0x4c, 0x24, 0xf7, 0xf1, 0x3b, 0x32, 0x96, 0xc0, 0xee, 0x5d, 0x0e, 0x0a, 0x8c, 0xef, 0x8b, 0xc8, 0xa9, 0x66, 0x28, 0x78, 0x80, 0x53, 0xb0, 0x28, 0x93, 0xa7, 0x81, 0x74, 0x38, 0x29, 0x66, 0x28, 0xdc, 0xed, 0x6e, 0xbf, 0x3f, 0x9b, 0xbe, 0xc0, 0xe0, 0x12, 0x2d, 0x1c, 0x1c, 0x02, 0x9d, 0x81, 0x44, 0x9d, 0x3c, 0x0a, 0x13, 0xf7, 0x04, 0x9a, 0x17, 0x0d, 0x82, 0xf0, 0x56, 0xe8, 0x5b, 0x37, 0x4f, 0xb0, 0x99, 0xc9, 0x34, 0x25, 0x69, 0xfc, 0x80 }) // The CircuitPython heap was corrupted because the stack was too small.\r\nPlease increase the stack size if you know how, or if not:
...
TRANSLATION("Invalid PWM frequency", 22, { 0xee, 0x5e, 0x67, 0x64, 0xa9, 0x77, 0xff, 0x9f, 0xd8, 0xb4, 0x71, 0xe3, 0x80, 0xb4, 0xe0 }) // Invalid PWM frequency
TRANSLATION("Bytes must be between 0 and 255.", 33, { 0xfc, 0xf8, 0x91, 0x05, 0xbe, 0x22, 0x4b, 0x30, 0x59, 0x89, 0xe8, 0x02, 0x97, 0xb0, 0x8d, 0x6a, 0x5f, 0x77, 0xe1, 0xf8, 0x75, 0x80 }) // Bytes must be between 0 and 255.
...
TRANSLATION("Press any key to enter the REPL. Use CTRL-D to reload.", 55, { 0xef, 0x71, 0x10, 0x46, 0xbc, 0x17, 0x80, 0xe0, 0xa5, 0x88, 0x2c, 0x87, 0x29, 0xd8, 0x17, 0xc7, 0xb7, 0xbf, 0xf5, 0xeb, 0x2f, 0xa4, 0x02, 0xf6, 0xfc, 0xfe, 0x3f, 0xaf, 0xab, 0xdc, 0x52, 0xc4, 0xe2, 0xcc, 0x75, 0xeb }) // Press any key to enter the REPL. Use CTRL-D to reload.
...
TRANSLATION("CircuitPython core code crashed hard. Whoops!\n", 48, { 0xf6, 0xa3, 0xd3, 0x09, 0x3d, 0xfc, 0x4e, 0xcc, 0xa5, 0x46, 0x70, 0x54, 0x6a, 0x82, 0xa3, 0x9c, 0x6c, 0x2a, 0x5b, 0x1b, 0xd7, 0xac, 0xbf, 0xce, 0xcc, 0xd7, 0x8f, 0xf6, 0xf3, 0xf9, 0x80 }) // CircuitPython core code crashed hard. Whoops!\r\n
TRANSLATION("The microcontroller's power dipped. Make sure your power supply provides\nenough power for the whole circuit and press reset (after ejecting CIRCUITPY).\n", 155, { 0xf9, 0xec, 0x0b, 0x74, 0xa3, 0xb5, 0x19, 0x65, 0xda, 0xd6, 0x0f, 0xca, 0x0a, 0xed, 0xd0, 0x39, 0x55, 0x2f, 0x71, 0x5e, 0xb2, 0xfd, 0x8f, 0xc0, 0x14, 0x61, 0xc1, 0x70, 0xd8, 0x72, 0xbb, 0x74, 0x0e, 0x51, 0x8b, 0xde, 0xdc, 0x15, 0xdd, 0xb9, 0xa5, 0x44, 0x79, 0xfc, 0xc1, 0x5b, 0x1a, 0xec, 0x57, 0x6e, 0x81, 0xcb, 0x46, 0x72, 0x9d, 0x81, 0x74, 0xd9, 0xac, 0x0a, 0x88, 0xf4, 0xc2, 0x49, 0x1a, 0xd4, 0xae, 0xe2, 0x20, 0x9c, 0x40, 0x92, 0xf4, 0x1e, 0x92, 0x1c, 0x87, 0xd4, 0x52, 0x51, 0x75, 0x2f, 0x6f, 0x77, 0xc7, 0xdb, 0xf4, 0xee, 0xf9, 0xf7, 0xff, 0xe7, 0xa7, 0xaf, 0xcf, 0xe6 }) // The microcontroller\'s power dipped. Make sure your power supply provides\r\nenough power for the whole circuit and press reset (after ejecting CIRCUITPY).\r\n
...
TRANSLATION("Buffer incorrect size. Should be %d bytes.", 43, { 0xfc, 0xf1, 0xa6, 0x81, 0xc9, 0x16, 0x8c, 0xee, 0x29, 0x25, 0x09, 0xfb, 0x8e, 0xb2, 0xf9, 0x6c, 0xd8, 0xb5, 0x4b, 0x30, 0x5d, 0x55, 0x2c, 0xf8, 0x91, 0x1d, 0x60 }) // Buffer incorrect size. Should be %d bytes.
...
TRANSLATION("USB Busy", 9, { 0xfa, 0x7c, 0xbf, 0x32, 0xfc, 0xf1, 0x1c, 0x00 }) // USB Busy
...
TRANSLATION("Cannot remount '/' when USB is active.", 39, { 0xf6, 0x9a, 0xab, 0x49, 0x38, 0xdd, 0xb0, 0xb2, 0x5c, 0xbd, 0x7c, 0x8b, 0xa6, 0xc1, 0x4b, 0xe9, 0xf2, 0xfc, 0xc9, 0x20, 0x8e, 0x92, 0x9c, 0xc7, 0x58 }) // Cannot remount \'/\' when USB is active.
TRANSLATION("Crash into the HardFault_Handler.", 34, { 0xf6, 0xb9, 0xc6, 0xc4, 0x8b, 0x2c, 0x53, 0xb0, 0x2f, 0xec, 0x6f, 0x5f, 0xd0, 0xf1, 0x69, 0xcb, 0xfb, 0x1a, 0xd6, 0xc1, 0xfa, 0xc0 }) // Crash into the HardFault_Handler.
...
TRANSLATION("function takes exactly 9 arguments", 35, { 0xd3, 0x0b, 0x49, 0x46, 0x52, 0x93, 0xf0, 0x10, 0x43, 0xc8, 0xe9, 0x36, 0xe0, 0xbf, 0xe8, 0x8d, 0xf5, 0xc6, 0xe1, 0x66, 0x00 }) // function takes exactly 9 arguments
TRANSLATION("LHS of keyword arg must be an id", 33, { 0xfd, 0x7f, 0xb7, 0xc8, 0x9b, 0x42, 0xf0, 0x1c, 0x74, 0x67, 0xa9, 0x1b, 0xea, 0x5b, 0xe2, 0x24, 0xb3, 0x04, 0x6a, 0x49, 0x50 }) // LHS of keyword arg must be an id
...
// 4064 bytes worth of qstr
// 9969 bytes worth of translations
// 6056 bytes worth of translations compressed
// 3913 bytes saved
