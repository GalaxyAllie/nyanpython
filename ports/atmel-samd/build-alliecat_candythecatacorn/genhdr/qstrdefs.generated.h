...
// 54 6 10 11111110010 2034
// 56 8 7 11111110011 2035
// 60 < 9 11111110100 2036
// 62 > 10 11111110101 2037
// 71 G 5 11111110110 2038
// 72 H 5 11111110111 2039
// 75 K 7 11111111000 2040
// 86 V 7 11111111001 2041
...
// values ['e', ' ', 'a', 'i', 'n', 'o', 'r', 's', 't', 'c', 'd', 'l', 'p', 'u', '_', 'b', 'f', 'g', 'h', 'm', 'y', "'", 'v', 'w', '%', '.', 'A', 'E', 'I', 'P', 'k', 'q', 'x', '\n', '\r', '(', ')', '-', '/', '0', 'C', 'D', 'N', 'O', 'R', 'S', 'T', 'U', 'j', ',', '1', '2', '3', '5', ':', 'B', 'F', 'L', 'M', 'W', 'z', '*', '4', '6', '8', '<', '>', 'G', 'H', 'K', 'V', 'X', '!', '"', '#', '7', '9', '=', 'Y', '`', '+', '{', '}', ';', 'Z'] lengths 15 bytearray(b'\x00\x00\x01\x08\x05\x07\x03\t\x10\x0c\x0b\x08\x03\x02\x00')
// estimated total memory size 68189
// ['e', ' ', 'a', 'i', 'n', 'o', 'r', 's', 't', 'c', 'd', 'l', 'p', 'u', '_', 'b', 'f', 'g', 'h', 'm', 'y', "'", 'v', 'w', '%', '.', 'A', 'E', 'I', 'P', 'k', 'q', 'x', '\n', '\r', '(', ')', '-', '/', '0', 'C', 'D', 'N', 'O', 'R', 'S', 'T', 'U', 'j', ',', '1', '2', '3', '5', ':', 'B', 'F', 'L', 'M', 'W', 'z', '*', '4', '6', '8', '<', '>', 'G', 'H', 'K', 'V', 'X', '!', '"', '#', '7', '9', '=', 'Y', '`', '+', '{', '}', ';', 'Z'] bytearray(b'\x00\x00\x01\x08\x05\x07\x03\t\x10\x0c\x0b\x08\x03\x02\x00')
...
TRANSLATION("LHS of keyword arg must be an id", 33, { 0xfd, 0x3f, 0xbf, 0xc8, 0x9b, 0x42, 0xf0, 0x1c, 0x74, 0x67, 0xa9, 0x1b, 0xea, 0x5b, 0xe2, 0x24, 0xb3, 0x04, 0x6a, 0x49, 0x50 }) // LHS of keyword arg must be an id
...
TRANSLATION("PWM duty_cycle must be between 0 and 65535 inclusive (16 bit resolution)", 73, { 0xef, 0xfd, 0xbf, 0x52, 0xae, 0x27, 0x8c, 0xa9, 0xc5, 0x2c, 0x0b, 0x7c, 0x44, 0x96, 0x60, 0xb3, 0x13, 0xd0, 0x05, 0x2f, 0x61, 0x1a, 0xd4, 0xbf, 0x97, 0xe1, 0xf8, 0x7d, 0xff, 0x81, 0x22, 0xd2, 0xd8, 0x84, 0xe6, 0x0b, 0xd1, 0xf6, 0xff, 0x22, 0xcd, 0x24, 0x9c, 0x43, 0x5b, 0x12, 0x8c, 0xbe, 0x90 }) // PWM duty_cycle must be between 0 and 65535 inclusive (16 bit resolution)
...
TRANSLATION("RTS/CTS/RS485 Not yet supported on this device", 47, { 0xf8, 0xfc, 0xfe, 0x5e, 0xbf, 0x6f, 0xcf, 0xe5, 0xeb, 0xf8, 0xfc, 0xbf, 0x8f, 0xf3, 0xfc, 0x0b, 0xde, 0xd2, 0x5c, 0x09, 0x28, 0xc5, 0xee, 0xcf, 0x22, 0xa4, 0xca, 0x53, 0xb2, 0x41, 0x54, 0x73, 0x4a, 0x00 }) // RTS/CTS/RS485 Not yet supported on this device
...
TRANSLATION("AnalogOut is only 16 bits. Value must be less than 65536.", 58, { 0xec, 0x53, 0xb3, 0x6b, 0xf0, 0xc4, 0x92, 0x41, 0x32, 0xdb, 0x82, 0xfb, 0x7f, 0x91, 0x66, 0x93, 0x1d, 0x65, 0xfe, 0x4e, 0xd8, 0x05, 0xbe, 0x22, 0x4b, 0x30, 0x56, 0x11, 0x05, 0x3b, 0x1a, 0x97, 0xf2, 0xfc, 0x3f, 0x0f, 0xbf, 0xf9, 0x75, 0x80 }) // AnalogOut is only 16 bits. Value must be less than 65536.
...
TRANSLATION("You are in safe mode: something unanticipated happened.\n", 58, { 0xff, 0xc6, 0xc1, 0x1b, 0x82, 0x45, 0x28, 0x3d, 0x01, 0x6e, 0xd5, 0x1f, 0x89, 0x43, 0x6e, 0x27, 0x64, 0x5d, 0x4b, 0x0a, 0x6b, 0x29, 0x44, 0xb9, 0xc8, 0xa9, 0x6c, 0x77, 0xb8, 0x51, 0x5e, 0xbf, 0x3f, 0x98 }) // You are in safe mode: something unanticipated happened.\r\n
...
TRANSLATION("calibration value out of range +/-127", 38, { 0xa1, 0xd9, 0x33, 0x73, 0x94, 0x65, 0x2e, 0x67, 0x6c, 0x02, 0x6c, 0x49, 0x36, 0x84, 0xe6, 0xba, 0x82, 0xff, 0xe7, 0xaf, 0xd5, 0xf6, 0xfd, 0xdf, 0xf2 }) // calibration value out of range +/-127
...
TRANSLATION("No free GCLKs", 14, { 0xf7, 0xb1, 0x68, 0xe0, 0x17, 0xf6, 0xf6, 0xfe, 0x9f, 0xe2, 0x00 }) // No free GCLKs
...
TRANSLATION("threshold must be in the range 0-65536", 39, { 0x9d, 0x9c, 0x46, 0xcd, 0x6a, 0x96, 0xf8, 0x89, 0x2c, 0xc1, 0x22, 0x94, 0xec, 0x09, 0xcd, 0x75, 0x05, 0xec, 0xf5, 0x7f, 0x2f, 0xc3, 0xf0, 0xfb, 0xff, 0x90 }) // threshold must be in the range 0-65536
...
TRANSLATION("generator ignored GeneratorExit", 32, { 0xd4, 0x28, 0x73, 0x96, 0x72, 0x4d, 0x55, 0x9c, 0x54, 0xbf, 0xb0, 0x50, 0xe7, 0x2c, 0xfd, 0xbe, 0x49, 0x20 }) // generator ignored GeneratorExit
...
TRANSLATION("WARNING: Your code filename has two extensions\n", 49, { 0xfd, 0xbb, 0x3e, 0x3e, 0xfe, 0xef, 0x7f, 0xf6, 0xfc, 0x4b, 0xff, 0x1b, 0x0e, 0x54, 0x6a, 0x82, 0xd1, 0x2c, 0x14, 0xf7, 0x05, 0xb1, 0xc1, 0x4f, 0x46, 0x21, 0xe5, 0x21, 0x61, 0x19, 0x63, 0xcf, 0xe6 }) // WARNING: Your code filename has two extensions\r\n
...
TRANSLATION("bits must be 7, 8 or 9", 23, { 0xcd, 0x26, 0x0b, 0x7c, 0x44, 0x96, 0x60, 0xbf, 0xe7, 0xec, 0x2f, 0xe6, 0x4c, 0xe5, 0xff, 0x40 }) // bits must be 7, 8 or 9
...
TRANSLATION("Failed to allocate RX buffer of %d bytes", 41, { 0xfc, 0xcd, 0x2c, 0x2a, 0x52, 0xc4, 0x76, 0xb3, 0x50, 0xe4, 0x17, 0xc7, 0xfd, 0x16, 0x78, 0xd3, 0x40, 0xe4, 0xda, 0x17, 0x55, 0x4b, 0x3e, 0x24, 0x40 }) // Failed to allocate RX buffer of %d bytes
...
TRANSLATION("bytes > 8 bits not supported", 29, { 0xcf, 0x89, 0x10, 0x5f, 0xd4, 0xbf, 0x99, 0x66, 0x93, 0x04, 0xad, 0x25, 0x18, 0xbd, 0xd9, 0xe4, 0x54 }) // bytes > 8 bits not supported
...
TRANSLATION("Crash into the HardFault_Handler.", 34, { 0xf6, 0xb9, 0xc6, 0xc4, 0x8b, 0x2c, 0x53, 0xb0, 0x2f, 0xee, 0x6f, 0x5f, 0xcc, 0xf1, 0x69, 0xcb, 0xfb, 0x9a, 0xd6, 0xc1, 0xfa, 0xc0 }) // Crash into the HardFault_Handler.
...
TRANSLATION("Array must contain halfwords (type 'H')", 40, { 0xec, 0x77, 0x3e, 0x0b, 0x7c, 0x44, 0x95, 0x19, 0x64, 0xd1, 0x4b, 0x63, 0xb6, 0x9d, 0x19, 0xeb, 0x05, 0xe8, 0x9e, 0x2e, 0x0b, 0x97, 0xf7, 0xe5, 0xe9 }) // Array must contain halfwords (type \'H\')
...
TRANSLATION("Stack size must be at least 256", 32, { 0xf9, 0x49, 0xd3, 0xc0, 0xa1, 0x3f, 0x70, 0x5b, 0xe2, 0x24, 0xb3, 0x04, 0x72, 0x56, 0x07, 0x12, 0x5f, 0x77, 0xe1, 0xfc, 0x80 }) // Stack size must be at least 256
...
TRANSLATION("int() arg 2 must be >= 2 and <= 36", 35, { 0x45, 0x9f, 0x47, 0xa4, 0x8d, 0xf5, 0x2f, 0xb8, 0xb7, 0xc4, 0x49, 0x66, 0x0b, 0xfa, 0xff, 0xd9, 0x7d, 0xc4, 0x6b, 0x52, 0xfe, 0x9f, 0xf6, 0x5f, 0x7f, 0xf2 }) // int() arg 2 must be >= 2 and <= 36
