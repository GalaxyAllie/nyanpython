...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_PAWS), MP_ROM_PTR(&pin_PA08) },

    { MP_ROM_QSTR(MP_QSTR_D1), MP_ROM_PTR(&pin_PA02) },
    { MP_ROM_QSTR(MP_QSTR_A0), MP_ROM_PTR(&pin_PA02) },
    { MP_ROM_QSTR(MP_QSTR_EAR_R), MP_ROM_PTR(&pin_PA02) },
    ...
    { MP_ROM_QSTR(MP_QSTR_TAIL1), MP_ROM_PTR(&pin_PA09) },
    ...
    { MP_ROM_QSTR(MP_QSTR_TAIL2), MP_ROM_PTR(&pin_PA06) },
    ...
    { MP_ROM_QSTR(MP_QSTR_EAR_L), MP_ROM_PTR(&pin_PA07) },

    { MP_ROM_QSTR(MP_QSTR_D13),MP_ROM_PTR(&pin_PA10) },
    { MP_ROM_QSTR(MP_QSTR_EYE_CORNERS),MP_ROM_PTR(&pin_PA10) },
